// refund policy page data

export const refundPolicyData = {
  title: "Refund Policy",
  data: [
    {
      subTitle: "Refund Policy Basic:",
      ulList: [
        "For Refund related issues on Swiggy and Zomato, reach out to their respective support team.",
        "For orders through thrive and direct ordering via Chef Kenzo, reach out to +91 9096907042.",
      ],
    },
    {
      subTitle: "Refund Policy:",
      olList: [
        "All refunds will be subject to the maximum of the order value.",
        "Refunds will be entertained only within 3 hours of the order delivery time.",
        "Refunds will be initiated to the source account.",
        "Refunds will be verified by the agent of Kenzo Kissan India Pvt Ltd and Kenzo Kissan India Pvt Ltd has the right to deny refund claims with proper reasoning to the customer.",
        "A refund can be also in the form of a coupon discount, credit notes and other such instruments and will be at the company's discretion.",
        "False claims will not be entertained.",
        "For bulk orders, refunds will not be processed.",
      ],
    },
  ],
};
...
export const privacyPolicyData1 = [
  {
...
export const privacyPolicyData3 = [
  {
    id: "1",
...
export const termAndConditionData = {
  ...
  description: [
    ...
    {
      id: "#8",
      text: "THIRD-PARTY WEBSITE AND CONTENT",
    },
    {
      id: "#9",
...
export const termAndConditionData2 = [
  {
    id: "1",
    title: "1. AGREEMENT TO TERMS",
    data: [
      {
        text: `These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Kenzo Kissan India Pvt Ltd ("Company," “we," “us," or “our”), concerning your access to and use of the https://chefkenzo.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in India and have our registered office at D-121 GF Sushant Shopping Arcade B Block Sushant Lok 1, Gurugram, Haryana 122009. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.`,
      },
      {
  ...
  },
  {
    ...
    data: [
      {
        text: "By using the Site, you represent and warrant that: (1) you have the legal capacity and you agree to comply with these Terms of Use; (2) you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Site; (3) you will not access the Site through automated or non-human means, whether through a bot, script, or otherwise; (4) you will not use the Site for any illegal or unauthorized purpose; and (5) your use of the Site will not violate any applicable law or regulation.",
      },
      {
    ...
    data: [
      ...
      },
      {
        ulList: [
          ...
          "Your Contributions do not violate any applicable federal, state, or local laws.",
  ...
  },
  {
    ...
    data: [
      {
        text: "You agree that we may access, store, process, and use any information and personal data that you provide following the terms of the Privacy Policy and your choices (including settings).",
      },
      {
  ...
  {
    id: "8",
    title: "8. THIRD-PARTY WEBSITE AND CONTENT",
    data: [
      {
  ...
  },
  {
    ...
    data: [
      {
        text: "These Terms shall be governed by and defined following the laws of India. Kenzo Kissan India Pvt Ltd and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.",
      },
    ],
  },
  {
    ...
    data: [
      ...
      {
        text: `Any dispute arising out of or in connection with this contract, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be three (3). The seat, or legal place, of arbitration shall be Gurugram , India. The language of the proceedings shall be English. The governing law of the contract shall be the substantive law of India.`,
      },
      {
