"use client";
import { SliderSwip } from "@/components";
...
const Events = () => {
  ...
  return (
    <section className="flex max-Width flex-col rounded-none">
      <div className="flex flex-col px-10 pt-11 pb-6 w-full bg-yellow-primary rounded-xl max-md:px-5 max-md:max-w-full">
          ...
          <div className="flex flex-wrap gap-5 items-center w-full max-md:max-w-full">
            <div className="flex flex-col grow shrink self-stretch my-auto min-w-[240px] w-[764px] max-md:max-w-full">
              <h2 className="text-3xl font-black leading-none text-zinc-900 max-md:max-w-full">
                <span>Our Past</span> Events <span>Testimonials!</span>
              </h2>
            ...
            <button
              ...
              className="gap-2.5 self-stretch px-5 py-2.5 my-auto text-lg text-center bg-red-primary rounded text-black-primary"
            >
              Get a Quote Now!
            </button>
          </div>
