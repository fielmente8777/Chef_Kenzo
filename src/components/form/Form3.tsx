...
const Form3 = ({ gridView }: Props) => {
  ...
  return (
    <form
      ...
      className={`${gridView ? "flex flex-col divide-y divide-p1" : "grid md:grid-cols-4 items-center md:gap-3.5 box-shadow"} py-3 md:px-4 bg-transparent  max-md:divide-y divide-white`}
    >
